...
```
## If you are just testing the pretrained model, you can follow the [CPU Setup](#cpu-setup) instructions and then skip to the [Interactive Demo Application](#interactive-demo-application) section.
